...
<table>
  ...
  <tr>
    <td width="80%" style="vertical-align:top !important;">Тема 2.3.  Гнуття тонколистового металу. З’єднання деталей </td>
    <td width="10%" align="center"></td>
  </tr>  
  <tr>
    <td width="80%" style="vertical-align:top !important;">Тема 2.4. Вирівнювання, розмічання, різання дроту</td>
    <td width="10%" align="center"></td>
  </tr>
  <tr>
    <td width="80%" style="vertical-align:top !important;">Тема 2.5. Оздоблення та опорядження виробів із тонколистового металу та дроту</td>
    <td width="10%" align="center"></td>
  </tr>
  <tr>
